...
namespace BuyOrBye.Models
{
    public class User
    {
      ...
      //Post Indecision
        ...
        public User isSignInSuccModel(string email, string password)
        {
        ...
        //get user name to present in index page
        public List<User> giveUserEmailModel(string Email)
        {

            DBservices dbs = new DBservices();
            return dbs.giveUserEmailBL(Email);
        }
